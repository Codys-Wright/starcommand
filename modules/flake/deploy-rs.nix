...
in
{
  ...
  flake = flakeInputs: let
    ...
    nixosConfigs = flakeInputs.self.nixosConfigurations or { };
  ...
  in {
    ...
    deploy.nodes = lib.mapAttrs (hostName: cfg: let
      ...
      # Build deploy-rs packages with overlay for the target system
    ...
    in {
      ...
      sshOpts = [
        ...
        "-i" (builtins.getEnv "DEPLOY_SSH_KEY")
    ...
    checks = builtins.mapAttrs (system: deployLib:
      deployLib.deployChecks flakeInputs.self.deploy
